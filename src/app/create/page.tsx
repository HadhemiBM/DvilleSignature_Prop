  ...
  return (
    <>
      <div className={styles.blackDiv}>
        <h2 className={styles.h2}>Create New Property</h2>
      </div>
          ...
          >
            ...
            <div className={styles.formbold_input_flex}>
              ...
              <div>
                <label
                  htmlFor="Category"
                  className={styles.formbold_form_label}
                >
                  Category
                </label>
                <input
            ...
            <div className={styles.formbold_input_flex}>
              <div>
                ...
                <input
                  ...
                  name="Location"
                  id="Location"
                  placeholder="10 Zirak Road, Canada"
                  className={styles.formbold_form_input}
                  required
                />
              </div>
            ...
            <div className={styles.formbold_input_file}>
              <label htmlFor="upload" className={styles.formbold_input_label}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                ...
                <input
                  ...
                  id="upload"
                  required
                  className={styles.formbold_input_file_input}
                />
              </label>
            </div>

            <button className={styles.formbold_btn}>Create Property</button>
          </form>
        </div>
      </div>
    </>
